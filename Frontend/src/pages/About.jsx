    ...
    <main className="bg-orange-50 text-orange-950">
      <section className="bg-orange-950 text-white">
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-5 py-20 lg:grid-cols-[1fr_0.8fr] lg:px-8 lg:py-28">
          ...
          <div className="relative rounded-[2rem] bg-orange-500 p-8 text-center">
            <div className="mx-auto flex h-40 w-40 items-center justify-center overflow-hidden rounded-full bg-white ring-8 ring-orange-300/50">
              <img
            ...
            <p className="mt-7 text-2xl font-black">Made with heart.</p>
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="space-y-5 text-base leading-8 text-orange-950/65">
            <p>
              ...
              exciting, and easy to share.
            </p>
            <p>
              From our kitchen partners to the person at your door, we care
              about the small details that turn a delivery into a moment.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-y border-orange-200 bg-white">
        <div className="mx-auto grid max-w-7xl gap-8 px-5 py-16 sm:grid-cols-3 lg:px-8">
          {[
            ...
            <div
              key={label}
              className="border-orange-200 sm:border-r sm:last:border-0"
            >
              <p className="text-4xl font-black text-orange-600">{value}</p>
              <p className="mt-2 text-sm text-orange-950/60">{label}</p>
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-3">
          {[
            [
              "01",
              "Flavor first",
              "We look for meals that make the first bite memorable and the last one satisfying.",
            ],
            [
              "02",
              "People matter",
              "We build relationships with cooks, couriers, and customers one order at a time.",
            ],
            [
              "03",
              "Keep it warm",
              "Great service should feel thoughtful, from the kitchen to your front door.",
            ],
          ].map(([number, title, text]) => (
            <article key={number} className="rounded-3xl bg-orange-100 p-7">
      ...
      <section className="mx-5 mb-20 rounded-[2rem] bg-amber-300 lg:mx-auto lg:max-w-7xl">
        <div className="flex flex-col items-start justify-between gap-6 px-8 py-12 sm:flex-row sm:items-center sm:px-14">
          <div>
          ...
          <a href="/contact">
            <button
              type="button"
              onClick={onContact}
              className="rounded-full bg-orange-950 px-7 py-3.5 text-sm font-bold text-white hover:bg-orange-800"
            >
